      ...
      >
        <p className="mb-3 rounded-xl bg-amber-50 px-3.5 py-2.5 text-xs leading-6 text-amber-800">
          {newKey?.kind === 'fingerprint' ? (
            <>
              این کلید فقط همین یک‌بار نمایش داده می‌شود. آن را هنگام راه‌اندازی اولیهٔ ماژول
              ESP32 وارد کنید. اگر می‌خواهید تأیید تردد روی یک صفحه‌نمایش کنار درب هم دیده
              شود، همین کلید را در صفحه راه‌اندازی تبلت (<span dir="ltr">/kiosk</span>) هم وارد
              کنید — صفحه به‌جای دوربین، وضعیت زندهٔ اثر انگشت را نشان می‌دهد.
            </>
          ) : (
            <>
